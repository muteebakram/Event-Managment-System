...
<?php
  ...
  if(mysqli_connect_error())
   ...
   $query="SELECT name, t.email, phoneno, description FROM user u, ticket t WHERE u.email=t.email ";
  ...
  {
      echo "   Nobody has booked the ticket :(";
  }
...
<body>
  ...
  <p align="left"> 
      <button class="button" name="submit">
          <a href="main_host.php" class="button">Back</a>
      </button>
  </p>
</body>
</html>